...
* In the second plot, the color scale uses a gradident, color changes from bright blue to dark blue as the sum of x,y deceases. Because there are only two different values in  vec_numeric, only two colors are shown on the plot.
